...
imagen = cv2.imread('C:/Users/arman/OneDrive/Documents/Practice/circulos.jpg')
...
if circulos is not None:
    ...
    for (x, y, r) in circulos:
        ...
        pixel_distance = np.sqrt ((x - referencia_circulo[0]) ** 2 + (y-referencia_circulo[1]))
        escala = escala_referencia / referencia_circulo[2]
        real_distancia = pixel_distance * escala 
...
cv2.imshow('Imagen con circulos', imagen)
cv2.waitKey(0)
